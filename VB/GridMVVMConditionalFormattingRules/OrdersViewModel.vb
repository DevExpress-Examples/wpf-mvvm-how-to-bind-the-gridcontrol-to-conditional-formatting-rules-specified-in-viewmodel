...
Namespace GridMVVMConditionalFormattingRules
    ...
    Public Class ViewModel
        ...
        Public Sub New()
            ...
            Rules = New ObservableCollection(Of FormattingRule)() From {New FormattingRule("Total", ConditionRule.Less, 0, True, FormattingType.Background), New FormattingRule(NameOf(Order.Discount), ConditionRule.Greater, 0, False, FormattingType.Font), New FormattingRule(NameOf(Order.Discount), ConditionRule.Greater, 0, False, FormattingType.Icon)}
        End Sub
